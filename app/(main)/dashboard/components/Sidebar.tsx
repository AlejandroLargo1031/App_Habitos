...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:block w-72 h-screen fixed left-0 pt-20 text-white p-6 shadow-xl border-r bg-white">
      ...
      {/* Barra de navegación horizontal para móvil */}
      <nav className="md:hidden fixed top-16 left-0 w-full bg-white shadow-md z-40 overflow-x-auto">
        <div className="flex gap-2 p-2">
          <Link href="/dashboard">
            <Button
              variant="ghost"
              className={`whitespace-nowrap justify-start gap-2 px-3 py-2 rounded-lg ${
                pathname === "/dashboard" ? "bg-gray-200" : ""
              }`}
            >
          ...
          <Link href="/dashboard/habits">
            ...
            >
              ...
              <span className="text-sm text-black">Mis Hábitos</span>
            </Button>
          </Link>
          ...
          <Link href="/dashboard/hydration">
            ...
            >
              ...
              <span className="text-sm text-black">Hidratación</span>
            </Button>
          </Link>
          ...
          <Link href="/dashboard/achievements">
            ...
            >
              ...
              <span className="text-sm text-black">Logros</span>
            </Button>
          </Link>
        </div>
      </nav>
